...
type Service interface {
	...
	Create(ctx context.Context, createDto dto.CreateDto) (domain.User, error)
	Update(ctx context.Context, updateDto dto.UpdateDto) (domain.User, error)
...
func (s *service) Create(ctx context.Context, createDto dto.CreateDto) (domain.User, error) {
	var err error
...
func (s *service) Update(ctx context.Context, updateDto dto.UpdateDto) (domain.User, error) {
	var userEntity domain.User
